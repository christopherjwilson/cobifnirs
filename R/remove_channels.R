...
#' @param channels (VECTOR) Channel names to remove from the NIRS data. The channel names must match the names in the *optode* column of the nirs data (i.e., 1-16).
